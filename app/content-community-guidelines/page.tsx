      ...
      <div className="mt-20 mx-auto h-full w-full block p-2 max-w-4xl px-4">
        <div className="h-full w-full">
          ...
          <div className="mx-auto text-white font-light text-xs space-y-6">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-2">a. Adherence to Applicable Laws</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-2">c. Harassment or Bullying</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-2">d. Intellectual Property</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-2">f. Hate Speech and Propaganda</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-2">g. Abuse, Self-Injury or Suicide</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-2">h. Illegal Activities</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-2">j. Misinformation</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-2">l. Impersonation</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-2">m. Security Breaches</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-2">n. Use of Our Content</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-2">Consequences</h3>
            <p>
            ...
            <p className="mt-4">We expect you to respect these guidelines and help us create a safe and enjoyable community for everyone. Thank you for being a part of DudePro!</p>
          </div>
        </div>
      </div>
