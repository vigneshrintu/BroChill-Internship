...
const Policy = () => {
  return (
    <main className="container mx-auto p-2">
      <Header />
      <div className="max-w-4xl mx-auto px-4 bg-black-100 text-white p-2 rounded-lg shadow-lg">
        ...
        <div className="space-y-6 text-xs font-light">
          <p>
            We at DudePro recognize that your privacy is very important and take it seriously. This Privacy Policy (&ldquo;Privacy Policy&rdquo;) sets out how we collect, use and disclose your data when you use our website Home &ndash; DudePro (&ldquo;Website&rdquo;) and/or mobile application called DudePro (&ldquo;App&rdquo;). The Website and App are collectively referred to as the &ldquo;Platform&rdquo;. References to &ldquo;we&rdquo;, &ldquo;our&rdquo; or &ldquo;us&rdquo; or the &ldquo;Company&rdquo; shall mean the Platform. Any references to &ldquo;you&rdquo;, &ldquo;your&rdquo; or &ldquo;user&rdquo; shall mean any person or entity using our Platform. We will not use or share your information with anyone except as described in this Privacy Policy.
          </p>
          <p>
            This Privacy Policy is a part of and is to be read with the DudePro terms of use (&ldquo;Terms&rdquo;) <a href="https://www.dudepro.app/terms-of-service/" className="text-blue-400">https://www.dudepro.app/terms-of-service/</a>. By using this Platform, you agree to the terms and conditions of this Privacy Policy. You also consent to our use and disclosure of your Personal Information (as defined below) in the manner described in this Privacy Policy. The capitalized words used in this Privacy Policy but not defined herein shall have the meaning given to such words in the Terms. If you do not agree with the terms and conditions of this privacy policy, please do not use this platform.
          </p>
